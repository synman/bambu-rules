...
| `2026-03-08-full-snapshot` | 2026-03-08 | Full 6-repo snapshot; bambu-mcp attribution cleanup committed; bpa has 4 unstaged changes (user action required) |
...
⚠️ `bambu-printer-app` has 4 uncommitted modified files at baseline time (`.github/copilot-instructions.md`, `api/api.py`, `api/openapi_local.py`, `src/panels/Filament.jsx`) — user must commit those separately.
