...
- The system-level `<git_commit_trailer>` instruction provides Co-authored-by formatting for use *when a commit is explicitly requested*. Its existence does not grant permission to commit.
